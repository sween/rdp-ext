...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE omopcdm54.measurement (
...
CREATE TABLE omopcdm54.note_nlp (
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE omopcdm54.specimen (
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE omopcdm54.fact_relationship (
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE omopcdm54.location (
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE omopcdm54.care_site (
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE omopcdm54.provider (
			...
			gender_source_concept_id integer NULL );
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE omopcdm54.payer_plan_period (
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE omopcdm54.drug_era (
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE omopcdm54.dose_era (
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE omopcdm54.condition_era (
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE omopcdm54.episode (
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE omopcdm54.episode_event (
			episode_id integer NOT NULL,
			event_id integer NOT NULL,
			episode_event_field_concept_id integer NOT NULL );
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE omopcdm54.metadata (
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE omopcdm54.cdm_source (
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE omopcdm54.concept (
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE omopcdm54.vocabulary (
			vocabulary_id varchar(20) NOT NULL,
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE omopcdm54.domain (
			domain_id varchar(20) NOT NULL,
			domain_name varchar(255) NOT NULL,
			domain_concept_id integer NOT NULL );
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE omopcdm54.concept_class (
			concept_class_id varchar(20) NOT NULL,
			concept_class_name varchar(255) NOT NULL,
			concept_class_concept_id integer NOT NULL );
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE omopcdm54.concept_relationship (
			...
			invalid_reason varchar(1) NULL );
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE omopcdm54.relationship (
			relationship_id varchar(20) NOT NULL,
			...
			relationship_concept_id integer NOT NULL );
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE omopcdm54.concept_synonym (
			concept_id integer NOT NULL,
			concept_synonym_name varchar(1000) NOT NULL,
			language_concept_id integer NOT NULL );
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE omopcdm54.concept_ancestor (
			ancestor_concept_id integer NOT NULL,
			descendant_concept_id integer NOT NULL,
			min_levels_of_separation integer NOT NULL,
			max_levels_of_separation integer NOT NULL );
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE omopcdm54.source_to_concept_map (
			...
			invalid_reason varchar(1) NULL );
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE omopcdm54.drug_strength (
			drug_concept_id integer NOT NULL,
			...
			invalid_reason varchar(1) NULL );
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE omopcdm54.cohort (
			cohort_definition_id integer NOT NULL,
			subject_id integer NOT NULL,
			cohort_start_date date NOT NULL,
			cohort_end_date date NOT NULL );
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE omopcdm54.cohort_definition (
			cohort_definition_id integer NOT NULL,
